...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'machine_name', 'name'];
        }
    ...
    public function setMachineName($machine_name)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMachineName', [$machine_name]);

        return parent::setMachineName($machine_name);
    }
